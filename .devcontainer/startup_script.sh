...
echo "Run the following command to get your initial admin password to access Jenkins:"
echo "sudo cat /var/lib/docker/volumes/jenkins_home/_data/secrets/initialAdminPassword"
